...
export class MainService {
  ...
  public getInvitationById_Invitation(id: string): Observable<ConfirmationInviteContext> {
    return this.http.get<ConfirmationApiSuccess<ConfirmationInviteContext>>(
      `${this.BACKEND_URL}${this.PATH}/get-one-invitation-template-by-invitation/${id}`
    ).pipe(map((res) => res.data));
  }
}
