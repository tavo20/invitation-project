...
@Component({
  selector: 'app-laura-juan-count-down',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './laura-juan-count-down.component.html',
  styleUrl: './laura-juan-count-down.component.scss'
})
export class LauraJuanCountDownComponent implements OnInit, OnDestroy {
